...
void menu::init()
{
	...
	auto menu_window = std::make_shared< window >( _w( "FAGALITY " ), vec2( 800, 650 ), vec2( 100, 100 ), window_style::flags::none, std::vector<std::shared_ptr<tab>>
...
void menu::render_background() const
{
	...
	//menu::render::rect_filled_diamond_gradient( { 0, 0 }, { static_cast< float >( render::get_dimensions().Width ), static_cast< float >( render::get_dimensions().Height ) }, gui_color::palette::main_pink( 0 ), gui_color::palette::main_pink( 200 ) );
}
